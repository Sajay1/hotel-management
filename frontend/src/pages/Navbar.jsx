...
export default function Navbar() {
  ...
  return (
    <nav className="absolute flex justify-between bg-transparent bg-linear-65 min-w-full">
      ...
      {isMobileMenuOpen && (
        <div id="mobile-menu" className="absolute top-full left-0 w-full bg-black/50 md:hidden">
          <div className="space-y-1 px-2 pt-2 pb-3">
            ...
            <a href="/rooms" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Rooms</a>
            <a href="/contact" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
          </div>
        </div>
      )}
