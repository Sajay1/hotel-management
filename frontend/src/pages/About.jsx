    ...
    <>
      ...
      <div className="flex flex-col mb-12 sm:mb-16 md:mb-20 justify-center items-center p-4 sm:p-6 md:p-8">
        ...
        <div className="flex gap-4 mt-4 sm:mt-6">
          <LeftSquareOutlined className="text-3xl sm:text-4xl text-yellow-500 bg-yellow-500 cursor-pointer hover:scale-110 transition-transform" />
          <RightSquareOutlined className="text-3xl sm:text-4xl text-yellow-500 bg-yellow-500 cursor-pointer hover:scale-110 transition-transform" />
        </div>
      </div>
    </>
  );
