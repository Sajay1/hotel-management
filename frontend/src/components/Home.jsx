...
export default function Home() {
  return (
    <>
       <div className="flex flex-col justify-center text-white items-center bg-cover bg-center bg-local" style={{backgroundImage:`url(${img})`}}>
        <div className="mr-120 mt-20 mb-80 pt-30">
          <p className="text-4xl w-100 font-montserrat">WELCOME TO <span className="text-9xl font-averia">LUXURY</span> <span className="text-5xl tracking-widest">HOTELS</span></p>
          <p className="text-4xl mt-10 w-200 font-new-rocker">Book your stay and enjoy Luxury redefined at the most affordable rates.</p>
        </div>
      </div>
      ...
      <div className="m-20 grid grid-cols-2 gap-2">
        ...
        <div className="h-60 w-60 ml-50 bg-center bg-contain bg-no-repeat" style={{backgroundImage:`url(${img2})`}}></div>
      </div>
      <div className="m-20 grid grid-cols-2 gap-2">
        <div className="border-l p-4 mt-4">
          <p className="font-bold text-[30px] mb-5 font-averia">
        ...
        <div className="h-60 w-60 ml-50 bg-center bg-contain bg-no-repeat" style={{backgroundImage:`url(${img1})`}}></div>
      </div>
